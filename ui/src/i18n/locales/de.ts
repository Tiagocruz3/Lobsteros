...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.lobster/lobster.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von lobster dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
