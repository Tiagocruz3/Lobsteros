...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as LobsterApp);
      void loadAgents(host as unknown as LobsterApp);
      void loadToolsCatalog(host as unknown as LobsterApp);
      void loadNodes(host as unknown as LobsterApp, { quiet: true });
      void loadDevices(host as unknown as LobsterApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as LobsterApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as LobsterApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as LobsterApp, payload);
