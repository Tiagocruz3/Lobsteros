...
// High-end Classic OS Style Icons
// Sophisticated, premium icons inspired by macOS and classic desktop OS

export const icons = {
  // ===========================================
  // Classic OS Style App Icons - High End
  // ===========================================
  ...
  messageSquare: html`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M8 9h8" stroke-width="1"/>
      <path d="M8 13h5" stroke-width="1"/>
    </svg>
  `,
  ...
  barChart: html`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M3 8c3-2 6-3 9-1s6 1 9-1" stroke-width="1"/>
    </svg>
  `,
  ...
  radio: html`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M8.5 8.5C7 10 7 14 8.5 15.5"/>
      <path d="M15.5 8.5C17 10 17 14 15.5 15.5"/>
      <path d="M5 5c-3 3-3 11 0 14"/>
  ...
  zap: html`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M13 6l-2 4h4l-2 6" stroke-width="1" opacity="0.5"/>
    </svg>
  `,
  ...
  scheduler: html`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M2 12h2" stroke-width="1"/>
      <path d="M20 12h2" stroke-width="1"/>
      <path d="M12 2v2" stroke-width="1"/>
      <path d="M12 20v2" stroke-width="1"/>
    </svg>
  `,
  ...
  cloud: html`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      <path d="M17.5 19c0-1.7-1.3-3-3-3h-11a3 3 0 0 1-3-3c0-1.5 1-2.8 2.5-3 .2-2.4 2.3-4.3 4.7-4.3 1.5 0 2.8.7 3.6 1.8.6-.3 1.3-.5 2-.5 2.5 0 4.5 2 4.7 4.5 1.4.5 2.5 1.8 2.5 3.5 0 2-1.5 3.5-3.5 3.5z"/>
    </svg>
  `,
  ...
  flask: html`
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <path d="M12 18a2 2 0 0 0 2-2c0-1.5-2-1-2-3 0-1.5 2-1 2-3a2 2 0 0 0-2-2"/>
    </svg>
  `,
