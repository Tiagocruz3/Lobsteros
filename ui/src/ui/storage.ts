const KEY = "lobster.control.settings.v1";
const LEGACY_TOKEN_SESSION_KEY = "lobster.control.token.v1";
const TOKEN_SESSION_KEY_PREFIX = "lobster.control.token.v1:";
...
export function loadSettings(): UiSettings {
  const defaultUrl = (() => {
    ...
    const configured =
      ...
      typeof window.__LOBSTER_CONTROL_UI_BASE_PATH__ === "string" &&
      window.__LOBSTER_CONTROL_UI_BASE_PATH__.trim();
